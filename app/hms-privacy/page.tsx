...
export default function HMSPrivacyPage() {
  return (
        ...
        <div className="bg-white shadow-lg rounded-lg overflow-hidden">
          ...
          <div className="bg-blue-500 px-6 py-8">
            <div className="flex items-center">
              <div className="ml-4">
                <h1 className="text-3xl font-bold text-white">Modern Blog - HarmonyOS端用户隐私协议</h1>
          ...
          <div className="px-6 py-8 space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                欢迎使用我们的Modern Blog APP（以下简称"APP"）。我们非常重视您的隐私保护，本隐私协议详细说明了我们如何收集、使用和保护您的个人信息。
            ...
            <section>
              ...
              <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-4">
                <p className="text-blue-800">
                  <strong>安全承诺：</strong>所有用户信息都经过高度加密后存储在数据库中
                </p>
              </div>
              <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
